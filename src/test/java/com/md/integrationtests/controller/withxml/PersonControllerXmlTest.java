package com.md.integrationtests.controller.withxml;
...
import com.md.integrationtests.vo.PersonVO;
...
public class PersonControllerXmlTest extends AbstractIntegrationTest {
	...
	public void authorization() throws JsonMappingException, JsonProcessingException {
		AccountCredentialsVO user = new AccountCredentialsVO("mauricio", "admin123");
...
//					.header(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_MD)
					.body(person)
					.when()
					.post()
				.then()
